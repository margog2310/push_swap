...
#    Updated: 2024/07/31 22:49:16 by mganchev         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(SRCDIR)/sort/simple.c $(SRCDIR)/stack.c $(SRCDIR)/ft_lst.c $(SRCDIR)/utils.c $(SRCDIR)/misc.c
...
$(OBJDIR)/sort/simple.o $(OBJDIR)/stack.o $(OBJDIR)/ft_lst.o $(OBJDIR)/utils.o $(OBJDIR)/misc.o
